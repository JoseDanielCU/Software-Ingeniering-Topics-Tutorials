...
from .views import ImageViewFactory, HomePageView, ProductIndexView, ProductShowView, AboutPageView, ContactPageView, \
    ProductCreateView, CartView, CartRemoveAllView, ImageViewNoDI
